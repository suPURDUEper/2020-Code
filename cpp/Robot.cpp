...
void Robot::RobotInit()
{
  ...
  SmartDashboard::PutNumber("Trench Speed", .9);
  SmartDashboard::PutNumber("Init Line Speed", .7);
  SmartDashboard::PutNumber("Wall Speed", .5);
}
...
void Robot::TeleopPeriodic()
{
 ...
 /* --------------- Update Controller Values ----------------*/
  ...
  leftBumper1 = operatorController.GetRawButton(4);
  rightBumper1 = operatorController.GetRawButton(5);
  leftTrigger1 = operatorController.GetRawButton(6);
  rightTrigger1 = operatorController.GetRawButton(7);
  rightTrigger0 = driveController.GetRawButton(7);
  
  btnX1 = operatorController.GetRawButton(0);
  btnA1 = operatorController.GetRawButton(1);
  btnY1 = operatorController.GetRawButton(3);
  ...
  conveyorMotor.Set(conveyor()); // Set the conveyor to specific speed

  double trenchSpeed = SmartDashboard::GetNumber("Trench Speed", .9);
  double initSpeed = SmartDashboard::GetNumber("Init Line Speed", .7);
  double wallSpeed = SmartDashboard::GetNumber("Wall Speed", .5);
